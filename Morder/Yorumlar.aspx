<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yorumlar.aspx.cs" Inherits="Morder.Yorumlar" %>
<style type="text/css">
    .auto-style1 {
        width: 133%;
        height: 243px;
            ...
            <asp:Panel ID="pnlTexboxs" runat="server" Height="600px" Width="607px"   HorizontalAlign="Center" style="margin-left:150px;">
                ...
                <table class="auto-style1">
                    ...
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            ...
                            <asp:GridView ID="GwYorumlar" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSourceComments" Height="302px" Width="597px" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Customer_Phone" HeaderText="Müşteri Telefonu" SortExpression="Customer_Phone" />
                                    <asp:BoundField DataField="Date_of_Comment" HeaderText="Yorum Tarihi" SortExpression="Date_of_Comment" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceComments" runat="server" ConnectionString="<%$ ConnectionStrings:MorderConnectionString %>" SelectCommand="SELECT Customer.Customer_Name, Customer.Customer_Surname, Customer.Customer_Phone, Enterprise_Comments.Comment, Enterprise_Comments.Date_of_Comment FROM Customer INNER JOIN [Order] ON Customer.Customer_Id = [Order].Customer_Id INNER JOIN Enterprise_Comments ON [Order].Order_Id = Enterprise_Comments.Order_Id WHERE ([Order].Enterprise_Id = @Id)">
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="" Name="Id" SessionField="EnterpriseId" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
